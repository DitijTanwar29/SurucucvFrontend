...
import { uploadHeroImage, getHeroImage } from "../../../../services/operations/profileAPI"; // Import API functions
import { useSelector } from "react-redux";


export default function UpdatingHeroSectionImage() {
  ...
  // Fetch the existing hero image
  useEffect(() => {
    async function fetchHeroImage() {
      try {
        const response = await getHeroImage();
        setCurrentHeroImage(response.data.imageUrl); // Set image from API
      } catch (error) {

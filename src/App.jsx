  ...
  return (
    // bg-orange-400
        ...
        <Route
          exact
          path="/job/:jobId"
          element={<JobDetailsPage user={user} />}
        />
        ...
        >
          ...
          {user?.accountType === ACCOUNT_TYPE.ADMIN && (
            <>
              ...
              <Route path="edit-sector/:sectorId" element={<EditSector />} />

              <Route path="add-package" element={<AddPackage />} />
              {/* To Do : Update hero section image component -> for testing chirag */}
              <Route
                path="update-hero-section-image"
                element={<UpdateHeroSectionImage />}
              />
          ...
          {user?.accountType === ACCOUNT_TYPE.COMPANY && (
            <>
              ...
              <Route
                path="packages-for-company"
                element={<CompanyPackages />}
              />
              <Route
                path="packages-for-company/package-details/:packageId"
              ...
              {/* Advertisements */}
              <Route path="post-ads" element={<PostAdvertisement />} />
